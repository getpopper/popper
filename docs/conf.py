...
latex_documents = [
    (master_doc, "Popper.tex", u"Popper Documentation", u"Ivo Jimenez", "manual"),
]
...
man_pages = [(master_doc, "Popper", u"Popper Documentation", [u"Ivo Jimenez"], 1)]
